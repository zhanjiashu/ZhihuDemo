 ...
 * 【www.zhihu.com】的响应数据是 gzip 格式，Volley 不支持该格式，
 * 因此自定义 StringRequest 进响应数据进行 gzip 解码
 */
public class ZHStringRequest extends StringRequest {

    private final String TAG = getClass().getSimpleName();

    private final Response.Listener<String> mListener;

    public ZHStringRequest(int method, String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(method, url, listener, errorListener);
        mListener = listener;
    }

    public ZHStringRequest(String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
