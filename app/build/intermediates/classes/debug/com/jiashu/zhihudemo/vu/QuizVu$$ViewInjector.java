...
public class QuizVu$$ViewInjector<T extends com.jiashu.zhihudemo.vu.QuizVu> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296407, "field 'mTabStrip'");
    target.mTabStrip = finder.castView(view, 2131296407, "field 'mTabStrip'");
    view = finder.findRequiredView(source, 2131296408, "field 'mContentPager'");
    target.mContentPager = finder.castView(view, 2131296408, "field 'mContentPager'");
  }
